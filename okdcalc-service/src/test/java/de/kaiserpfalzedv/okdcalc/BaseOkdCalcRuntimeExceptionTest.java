 ...
 */
public class BaseOkdCalcRuntimeExceptionTest {
    private static final Logger LOG = LoggerFactory.getLogger(BaseOkdCalcRuntimeExceptionTest.class);

    private static final String MESSAGE = "message";
    private static final Exception CAUSE = new Exception("cause");

    private BaseOkdCalcRuntimeException service;
    ...
    public void shouldAcceptConstructorWithOnlyMessage() {
        service = new BaseOkdCalcRuntimeException(MESSAGE);
    ...
    public void setUpService() {
        service = new BaseOkdCalcRuntimeException(MESSAGE, CAUSE);
    }
}
